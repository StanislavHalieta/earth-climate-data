...
class HTTPRequest:
    def __init__(
        ...
        self.session.headers.update({"User-Agent": "ClimateDataCollector/1.0"})
    ...
    def _make_request(self, method, endpoint, data=None, params=None, **kwargs):
        ...
        try:
            ...
            if any(
                ext in url.lower()
                for ext in [".nc", ".zip", ".he5", ".csv", ".dap", ".gz"]
            ):
    ...
    def post(
        ...
        **kwargs,
        ...
        return self._make_request(
            method="POST", endpoint=endpoint, data=data, params=params, **kwargs
        )
