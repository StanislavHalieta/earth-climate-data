...
def get_latest_nasa_ozone_url() -> str:
    ...
    endpoint = f"opendap/HDF-EOS5/Aura_OMI_Level3/OMTO3d.003/{current_year}/contents.html"
    ...
    pattern = re.compile(r'OMI-Aura_L3-OMTO3d_\d{4}m\d{4}_v\d{3}-\d{4}m\d{4}t\d{6}\.he5')
    ...
    if not he5_files:
        raise FileNotFoundError(f"No .he5 files found in NASA catalog for year {current_year}")
